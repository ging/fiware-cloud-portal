...
CDMI.Actions = function (j, g) {
    ...
    return {
        ...
        deletecontainer: function (b, a, region) {
            var c, d, e;
        ...
        copyobject: function (b, a, c, d, e, region) {
            var g;
        ...
        uploadobject: function (b, a, c, t, d, region) {
            var e;
        ...
        downloadobject: function (b, a, c, region) {
            var d, e;
        ...
        deleteobject: function (b, a, c, region) {
            var d;
            check(region) && (b = h.url + "/" + b + "/" + a, a = function (a) {
                c !== g && c(a)
            }, d = function (a) {
