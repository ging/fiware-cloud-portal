...
IDM.Auth = (function (_IDM, undefined) {
    ...
    var getTenants = function (callback) {
        ...
        var tenants = {tenants: [{description: "Test for FIWARE deployments. Guille", enabled: true, id: "980ae4606f464bb8bc214999c596b158", name: "FIWARE"}]};
        params.currentTenant = tenants.tenants[0];
