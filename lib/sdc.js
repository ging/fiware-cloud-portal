...
ServiceDC.API = (function (_ServiceDC, undefined) {
	...
	var addRecipe = function (name, version, repo, url, config_management, sos, description, attributes, ports, dependencies, callback, callbackError, region) {
		...
		if (ports) data.recipe.ports = ports;
