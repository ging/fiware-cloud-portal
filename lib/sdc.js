...
ServiceDC.API = (function (_ServiceDC, undefined) {
	...
	var sdcUrl = '/sdc2/rest/';
	var xmlHead = '<?xml version="1.0" encoding="UTF-8"?>';


	var check = function () {
		x2js = x2js || new X2JS();
		vdc_id = vdc_id || IDM.Auth.params.currentTenant.id;
	...
	var sendRequest = function (method, url, body, callback, callbackError) {
		...
		var token = IDM.Auth.params.token;
	...
	var getProductList = function (callback, callbackError) {
	...
	var addProduct = function (name, description, attributes, callback, callbackError) {
	...
	var getProduct = function (product_id, callback, callbackError) {
	...
	var getProductReleases = function (product_id, callback, callbackError) {
	...
	var deleteProduct = function (product_id, callback, callbackError) {
	...
	var getProductAttributes = function (product_id, callback, callbackError) {
	...
	var installProductInstance = function (ip, fqn, product, callback, callbackError) {
	...
	var getProductInstanceList = function (callback, callbackError) {
	...
	var getProductInstance = function (productInstance_id, callback, callbackError) {
	...
	var uninstallProductInstance = function (productInstance_id, callback, callbackError) {
	...
	var updateProductInstance = function (productInstance_id, release_id, callback, callbackError) {
	...
	var reconfigureProductInstance = function (productInstance_id, attributes, callback, callbackError) {
