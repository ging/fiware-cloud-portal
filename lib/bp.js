...
BP.API = (function (_BP, undefined) {
	...
	var sendRequest = function (method, url, body, callback, callbackError) {
		...
		//var token = "ea1ae3d0bf684db9998e2ce9e64632c8";
		var token = "305f908a914a4f8781ba735b7bd08c40";
	...
	var createBlueprintTemplateTier = function (bp_id, tier, callback, callbackError) {
		...
		sendRequest('POST', 'catalog/org/' + orgName + '/vdc/' + vdc_id + '/environment/' + bp_id + '/tier', xmlTier, callback, callbackError);
	};
