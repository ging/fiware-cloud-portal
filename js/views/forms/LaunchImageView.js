var LaunchImageView = Backbone.View.extend({
    ...
    render: function () {
        ...
        $(this.el).append(this._template({model:this.model, flavors: flavors, keypairs: this.options.keypairs, secGroups: this.options.secGroups, quotas: this.options.quotas, instancesModel: this.options.instancesModel}));
        $('#launch_image').modal();
        return this;
    },
